...
namespace B2MML.NET
{
    ...
    public class ConsumableActualType {
        ...
        private List<ConsumableActualPropertyType> _consumableActualPropertyField;
        ...
        public List<ConsumableActualPropertyType> ConsumableActualProperty {
            get => _consumableActualPropertyField;
            set => _consumableActualPropertyField = value;
        }
