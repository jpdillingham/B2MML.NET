...
namespace B2MML.NET
{
    ...
    public class ConsumableExpectedRequirementType {
        ...
        private List<ConsumableExpectedRequirementPropertyType> _consumableExpectedRequirementPropertyField;
        ...
        public List<ConsumableExpectedRequirementPropertyType> ConsumableExpectedRequirementProperty {
