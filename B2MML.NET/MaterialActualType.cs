...
namespace B2MML.NET
{
    ...
    public class MaterialActualType {
        ...
        private List<MaterialActualType> _assemblyActualField;
    
        private AssemblyTypeType _assemblyTypeField;
    
        private AssemblyRelationshipType _assemblyRelationshipField;
    
        private List<MaterialActualPropertyType> _materialActualPropertyField;
        ...
        public List<MaterialActualType> AssemblyActual {
        ...
        public List<MaterialActualPropertyType> MaterialActualProperty {
