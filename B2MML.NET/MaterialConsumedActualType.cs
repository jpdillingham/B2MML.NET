...
namespace B2MML.NET
{
    ...
    public class MaterialConsumedActualType {
        ...
        private List<MaterialConsumedActualPropertyType> _materialConsumedActualPropertyField;
        ...
        public List<MaterialConsumedActualPropertyType> MaterialConsumedActualProperty {
