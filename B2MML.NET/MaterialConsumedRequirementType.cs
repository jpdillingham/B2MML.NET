...
namespace B2MML.NET
{
    ...
    public class MaterialConsumedRequirementType {
        ...
        private List<MaterialConsumedRequirementPropertyType> _materialConsumedRequirementPropertyField;
        ...
        public List<MaterialConsumedRequirementPropertyType> MaterialConsumedRequirementProperty {
            get => _materialConsumedRequirementPropertyField;
            set => _materialConsumedRequirementPropertyField = value;
        }
