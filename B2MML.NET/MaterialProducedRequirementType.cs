...
namespace B2MML.NET
{
    ...
    public class MaterialProducedRequirementType {
        ...
        private List<MaterialProducedRequirementPropertyType> _materialProducedRequirementPropertyField;
        ...
        public List<MaterialProducedRequirementPropertyType> MaterialProducedRequirementProperty {
            get => _materialProducedRequirementPropertyField;
            set => _materialProducedRequirementPropertyField = value;
        }
