...
namespace B2MML.NET
{
    ...
    public class OpPersonnelCapabilityType {
        ...
        private List<OpPersonnelCapabilityPropertyType> _personnelCapabilityPropertyField;
        ...
        public List<OpPersonnelCapabilityPropertyType> PersonnelCapabilityProperty {
