...
namespace B2MML.NET
{
    ...
    public class OpPersonnelSpecificationType {
        ...
        private List<OpPersonnelSpecificationPropertyType> _personnelSpecificationPropertyField;
        ...
        public List<OpPersonnelSpecificationPropertyType> PersonnelSpecificationProperty {
