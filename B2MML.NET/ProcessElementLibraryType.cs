namespace B2MML.NET
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("ProcessElementLibrary", Namespace="http://www.mesa.org/xml/B2MML-V0600", IsNullable=false)]
    public partial class ProcessElementLibraryType {
        ...
        public ProcessElementType[] ProcessElementSpec {
            get {
                return this.processElementSpecField;
            }
            set {
                this.processElementSpecField = value;
            }
        }
    }
}