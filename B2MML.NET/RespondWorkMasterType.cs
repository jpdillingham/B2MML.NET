namespace B2MML.NET
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("RespondWorkMaster", Namespace="http://www.mesa.org/xml/B2MML-V0600", IsNullable=false)]
    public partial class RespondWorkMasterType {
    
        private TransApplicationAreaType applicationAreaField;
    
        private RespondWorkMasterTypeDataArea dataAreaField;
